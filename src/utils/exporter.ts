...
function _writeAudioBufferToArray(audioBuffer: AudioBuffer, targetArray: Uint8Array, offset: number, bitDepth: 16 | 32) {
    let index = 0;
    let channel = 0;
 ...
 */
function _createWaveFileBlobFromAudioBuffer(audioBuffer: AudioBuffer, as32BitFloat: boolean): Blob {
    // Encoding setup.
...
function createLinkFromAudioBuffer(audioBuffer: AudioBuffer, as32BitFloat: boolean) {
